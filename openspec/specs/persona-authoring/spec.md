...
## Purpose
Defines the optional, logical-target-scoped, approval-gated mechanism for inspecting and atomically revising active Persona trait assets with compare-and-swap and HMR confirmation.
## Requirements
...
#### Scenario: A configured Persona preset enables one writable trait
- **ID**: `persona-authoring.policy.configured-writable`
