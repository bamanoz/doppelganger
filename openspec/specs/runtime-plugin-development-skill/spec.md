# runtime-plugin-development-skill Specification

## Purpose
Defines the cross-host Agent Skill workflow for developing and operating temporary Dynamic Runtime Plugins through inspected contracts, reversible Cordis effects, and explicit native approval.
## Requirements
