...
- **EVIDENCE**: `packages/composition-runtime/tests/serialized-activation.spec.ts::rejects non-absolute boundary paths and unknown hosts`
...
- **EVIDENCE**: `packages/composition-runtime/tests/serialized-activation.spec.ts::canonicalizes equivalent direct and serialized composition inputs identically`
...
- **ID**: `composition.runtime.canonicalization.omit.absent`
- **EVIDENCE**: `packages/composition-runtime/tests/serialized-activation.spec.ts::canonicalizes equivalent direct and serialized composition inputs identically`
...
- **ID**: `composition.runtime.public.api.domain.neutral`
- **EVIDENCE**: `packages/composition-runtime/tests/composition-runtime.spec.ts::activates arbitrary modules, protected root plugins, and immutable metadata`
- **EVIDENCE**: `packages/composition-runtime/tests/serialized-activation.spec.ts::describes only generic layered runtime inputs`
...
Runtime-owned host plugins SHALL be inserted after caller-controlled layers, and the fully layered composition SHALL be audited before a Runtime Session is returned.
...
- **ID**: `composition.runtime.activation.empty.host.integration`
