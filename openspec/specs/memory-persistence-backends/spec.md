# Memory Persistence Backends Specification

## Purpose
Define interchangeable SQLite and PostgreSQL canonical memory repositories that preserve durable memory semantics, operational guarantees, and lifecycle behavior across local and shared deployments.
