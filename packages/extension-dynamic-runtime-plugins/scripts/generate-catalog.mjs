...
const catalog = {
  services: [
    ...
    },
    {
      ...
      methods: ['snapshot(): ToolCatalogSnapshot', 'register(definition: ToolDefinition): () => Promise<void>'],
      properties: [],
  ...
  events: [
    { name: 'doppelganger/tools-changed', mode: 'parallel', signature: '(revision: string): Promise<void> | void' },
  ...
  referencedTypes: {
    ...
    ToolRegistration: { source: 'packages/extension-protocols/src/tools.ts', shape: 'Withheld from generated code; registration returns only an owned asynchronous disposer function.' },
