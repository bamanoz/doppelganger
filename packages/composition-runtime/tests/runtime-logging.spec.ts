...
describe('runtime logging integration', () => {
  ...
  it('exports core and first-party component operational events without sensitive payloads', async () => {
    ...
    await writeFile(definition.loaderPath, JSON.stringify([
      ...
      { id: 'memory-sqlite', name: '@doppelganger/doppelganger-memory/sqlite', inject: ['doppelgangerActor'], isolate: { doppelgangerActor: 'session', doppelgangerMemoryRepository: 'session' }, config: { home: storage, namespace: 'memory' } },
      { id: 'memory', name: memoryModule, inject: ['doppelgangerActor', 'doppelgangerPersona', 'doppelgangerContext', 'doppelgangerTools', 'doppelgangerMemoryRepository'], isolate: { doppelgangerActor: 'session', doppelgangerPersona: 'session', doppelgangerContext: 'session', doppelgangerTools: 'session', doppelgangerMemoryRepository: 'session', doppelgangerMemory: 'session', doppelgangerMemorySemantic: 'session' } },
