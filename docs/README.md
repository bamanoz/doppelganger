...
| Research | [OpenClaw extension surface](research/host-extension-surfaces/openclaw.md) | Source-pinned OpenClaw discovery, registration, prompt, tool, lifecycle, reload, and authority evidence |
