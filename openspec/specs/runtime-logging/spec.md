...
Defines default-off Runtime Session logging over Cordis `ctx.logger`, bounded session routing and sink ownership, independently composed rolling JSONL and private Sentry destinations, reload/disposal behavior, and OMP transport neutrality.
...
- **EVIDENCE**: `packages/composition-runtime/tests/runtime-logging.spec.ts::keeps exporter-omitting sessions silent while plugins use ctx.logger`
...
- **EVIDENCE**: `packages/composition-runtime/tests/runtime-logging.spec.ts::captures activation logs before exporter rows settle`
...
- **EVIDENCE**: `packages/composition-runtime/tests/runtime-logging.spec.ts::isolates records and sinks across concurrent Runtime Sessions`
...
- **EVIDENCE**: `packages/composition-runtime/tests/runtime-logging.spec.ts::replays the bounded activation buffer once to every initial sink`
...
- **EVIDENCE**: `packages/composition-runtime/tests/runtime-logging.spec.ts::releases early records after exporter-omitting activation settles`
...
- **EVIDENCE**: `packages/composition-runtime/tests/runtime-logging.spec.ts::drops the oldest activation records at the fixed buffer bound`
...
- **EVIDENCE**: `packages/composition-runtime/tests/runtime-logging.spec.ts::delivers one record independently to multiple session sinks`
...
- **EVIDENCE**: `packages/extension-logging-file/tests/file-exporter.spec.ts::applies exact logger overrides before destination queueing`
- **EVIDENCE**: `packages/extension-logging-sentry/tests/sentry-exporter.spec.ts::applies exact independent level filters`
...
- **EVIDENCE**: `packages/extension-logging-file/tests/file-exporter.spec.ts::rotates before the threshold-crossing record and retains exact generations`
...
- **EVIDENCE**: `packages/extension-logging-file/tests/file-exporter.spec.ts::drains accepted writes and closes the file exactly once on disposal`
...
- **EVIDENCE**: `packages/extension-logging-file/tests/file-exporter.spec.ts::contains operational filesystem failure and stops the failed sink`
...
- **EVIDENCE**: `packages/extension-logging-sentry/tests/sentry-exporter.spec.ts::fails activation when the exact configured DSN environment variable is unavailable`
...
- **EVIDENCE**: `packages/extension-logging-sentry/tests/sentry-exporter.spec.ts::bounds shutdown when the private transport does not drain`
