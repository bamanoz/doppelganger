# OpenClaw Host Specification

## Purpose

Defines the supported native OpenClaw adapter, finite prepared tool artifact, direct Runtime Session binding, authority-preserving context and approval projection, lifecycle limits, reload, and exhaustive disposal.
