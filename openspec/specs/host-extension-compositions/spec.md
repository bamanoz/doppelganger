# Host Extension Compositions Specification

## Purpose
Define the trusted host-owned extension plane that composes versioned native capabilities, immutable session facts, and lifecycle ownership into isolated Runtime Sessions without exposing raw host authority or Runtime Preset control.
