# Persistent Plugin Development Skill Specification

## Purpose

Define the portable, ownership-gated workflow for developing permanent installable Doppelganger plugin packages in a user-selected repository.
